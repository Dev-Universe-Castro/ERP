...
const PedidosTab = ({ data, getStatusBadge, onEdit, onDelete, onReceber }) => {
  if (data.length === 0) {
    return (
        ...
        <table className="w-full">
          <thead className="bg-gray-50">
            <tr>
              ...
              <th className="px-4 py-3 text-left text-sm font-medium text-gray-500">Cotação</th>
          ...
          <tbody className="divide-y divide-gray-200">
            {data.map((item, index) => (
              ...
              >
                ...
                <td className="px-4 py-3 text-sm text-gray-600">{item.cotacao}</td>
